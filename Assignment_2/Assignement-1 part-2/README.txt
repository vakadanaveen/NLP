...
When the flag is not passed, all the queries in the Cranfield dataset are considered and the Mean Average Precision is computed over all the queries. Additionally, the precision@k, recall@k and f-score@k values are computed for one sample query.
